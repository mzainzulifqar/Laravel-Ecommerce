     ...
     <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
      ...
      <div class="col-md-12">
        ...
        <a href="{{route('admin.product.create')}}" class="btn btn-primary">Add Product</a>
         <a href="{{route('admin.product.index')}}" class="btn btn-primary">View Product</a>
         </div>
         </div>
        @if(Session('message'))
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                ...
                <td> <a class="btn btn-primary btn-sm" href="{{route('admin.product.recover',$s->id)}}">Recover</a>
