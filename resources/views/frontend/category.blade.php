                    ...
                    <div class="col-sm-12">
                         @if(isset($product) && $product->isNotEmpty()) 
                                ...
                                <div class="col-md-5 col-md-offset-7">
                                    <div class="filter" style="padding-bottom: 30px;">
                            <h2 style="display:inline-block;margin-right:20px;">Price Filter</h2>
                            <a href="{{route('main.shop',['category'=> request()->category,'sortby'=>'low_to_high'])}}">Low to High</a>
                            <a href="{{route('main.shop',['category'=> request()->category,'sortby'=>'high_to_low'])}}"">High to low</a>
