...
<link rel="stylesheet" type="text/css" href="{{asset('public/theme/email.css')}}" />
			...
			<table>
				<tr>
					<td>
						...
						<p class="lead">This is your order you recently placed
        Order total : {{$orders->billing_total}}
        Order subtotal : {{$orders->billing_subtotal}}
        Order total : {{$orders->billing_discount_code}}</p>
						<!-- Callout Panel -->
						<p class="callout">
